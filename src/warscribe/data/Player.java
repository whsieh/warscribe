...
public class Player extends Character{
    ...
    public int getCon(){return stats[2];}
    public int getIntel(){return stats[3];}
    public int getWis(){return stats[4];}
    public int getCha(){return stats[5];}
    
    public int getAcrobatics(){return stats[6];}
    public int getArcana(){return stats[7];}
    public int getBluff(){return stats[8];}
    public int getDiplomacy(){return stats[9];}
    public int getDungeoneering(){return stats[10];}
    public int getEndurance(){return stats[11];}
    public int getHeal(){return stats[12];}
    public int getHistory(){return stats[13];}
    public int getInsight(){return stats[14];}
    public int getIntimidate(){return stats[15];}
    public int getNature(){return stats[16];}
    public int getPerception(){return stats[17];}
    public int getReligion(){return stats[18];}
    public int getStealth(){return stats[19];}
    public int getStreetwise(){return stats[20];}
    public int getThievery(){return stats[21];}
    public int getAthletics(){return stats[22];}
